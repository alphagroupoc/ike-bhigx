    ...
    $(".header-menu").each(function () {
      ...
      $this.find(".header-menu__item-link").each(function () {
        $(this).on("click", function () {
          if (
            $(this).parent().parent().find("> .header-menu__submenu").length < 1
          ) {
            resetMenu();
          }
        });
        ...
        if ($submenu.parent().parent().hasClass("header-menu__list")) {
          ...
          $link.on("click", function () {
            if (
              ...
              $parent
                ...
                .each(function () {
                  ...
                  if ($(this).hasClass("header-menu__item--dropdown")) {
                    $(this)
                      .find(".header-menu__item--hover")
                      .removeClass("header-menu__item--hover");
                    $(this).find(".header-menu__submenu").hide();
                  }
                });
              ...
              // Hide on click outside
              $("html").on(
                "click.lsvrBeautyspotHeaderMenuCloseSubmenuOnClickOutside touchstart.lsvrBeautyspotHeaderMenuCloseSubmenuOnClickOutside",
                function (e) {
                  desktopHideSubmenu();
                  $("html").unbind(
                    "click.lsvrBeautyspotHeaderMenuCloseSubmenuOnClickOutside touchstart.lsvrBeautyspotHeaderMenuCloseSubmenuOnClickOutside"
